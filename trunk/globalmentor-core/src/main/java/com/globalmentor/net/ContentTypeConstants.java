...
public class ContentTypeConstants //TODO transfer these constants to specific relevant classes and remove this class
{
	...
	public final static String X_DICTO_RDF_XML_SUBTYPE = ContentType.SUBTYPE_EXTENSION_PREFIX + "dicto" + ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR
			+ RDF_XML_SUBTYPE_SUFFIX;
	/** A Java application. */
	public final static String JAVA_SUBTYPE = "java";
	/** A MAQRO activity. */
	public final static String X_MAQRO_RDF_XML_SUBTYPE = ContentType.SUBTYPE_EXTENSION_PREFIX + "maqro" + ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR
			+ RDF_XML_SUBTYPE_SUFFIX; //TODO del; use MAQRO version
	/** A MAQRO question. */
	public final static String X_QRO_RDF_XML_SUBTYPE = ContentType.SUBTYPE_EXTENSION_PREFIX + "qro" + ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR
			+ RDF_XML_SUBTYPE_SUFFIX;
	/**
	...
	public final static String X_XEBOOK_RDF_XML_SUBTYPE = ContentType.SUBTYPE_EXTENSION_PREFIX + "xebook" + ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR
			+ RDF_XML_SUBTYPE_SUFFIX;
