...
public class XMLObjectDecoder {
	...
	/**
	 * Registers an object factory to be used to create objects encoded from elements in the specified namespace. If an object factory is already registered for
	 * this namespace, it will be replaced.
	 * @param namespaceURI The namespace of the elements for which this factory should be used to create objects.
	 * @param factory The object factory that will be used to create objects stored in elements from the given namespace namespace.
	 */
	...
	/**
	 * Retrieves a factory to be used for creating objects stored in elements from the specified namespace URI.
	 * @param namespaceURI The namespace for which an object factory should be returned.
	 * @return The factory registered for this namespace, or <code>null</code> if there is no factory registered for this namespace.
	 */
	 ...
	 * @return An array of object, each representing an XML element or <code>null</code> if an XML element was not recognized. /TODO add DOM exception here
	 */
	 ...
	 * @return An object that represents this XML element, or <code>null</code> if the element was not recognized. //TODO fix @throws SOAPException Thrown if
	 *         there is an error accessing the SOAP body element
	 */
	public Object decode(final Element element) {
		...
		if(xmlObjectFactory != null) //if we have a factory for creating elements from this namespace
			...
			//if we don't have an object factory
