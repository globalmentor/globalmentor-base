...
/**
 * Utilities for working with directories of type <code>text/directory</code> as defined in <a href="http://www.ietf.org/rfc/rfc2425.txt">RFC 2425</a>,
...
public class DirectoryUtilities
{
	...
	protected final static String[] TEXT_REPLACEMENT_STRINGS = new String[] { Directory.TEXT_ESCAPE_STRING + Directory.TEXT_LINE_BREAK_ESCAPED_LOWERCASE_CHAR,
			Directory.TEXT_ESCAPE_STRING + Directory.TEXT_ESCAPE_CHAR, Directory.TEXT_ESCAPE_STRING + Directory.VALUE_SEPARATOR_CHAR,
			Directory.TEXT_ESCAPE_STRING + Directory.TEXT_LINE_BREAK_ESCAPED_LOWERCASE_CHAR };
	...
	/*TODO del; this is too complicated, and wouldn't save us from creating an object 
