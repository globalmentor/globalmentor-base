...
/**
 * Creates an OEB publication by gathering all source files from a directory. If the tidy option is turned on, each document in the manifest will be loaded,
 * tidied, and saved after the original copy is renamed with a ".backup" extension.
 * <ul>
 * <li>All manifest items of type GIF are given fallback items of type PNG if a PNG file with the same name exists.</li>
 * </ul>
 * <p>
 * Options:
 * </p>
 ...
 * <ul>
 * <li>A <code>File</code> specifying the output directory or <code>null</code> to use the same directory as the source.</li>
 * </ul>
 * </li>
 * </ul>
...
public class OEBPublicationCreator //TODO update this class to work with XEbook; this class may not even function properly anymore
{
	...
	/**
	 * @return The output directory, or <code>null</code> if the default output directory should be used.
	 */
	 ...
	 */
	public void setOutputDir(final File newOutputDir) {
	 ...
	 */
	public void setContextURL(final URL newContextURL) {
		contextURL = newContextURL;
	}
	 ...
	 */
	public void setTitlePageURL(final URL newTitlePageURL) {
		titlePageURL = newTitlePageURL;
	}
	 ...
	 */
	public void setPrefaceURL(final URL newPrefaceURL) {
		prefaceURL = newPrefaceURL;
	}
	...
	protected boolean isProjectGutenbergEText() {
		return isProjectGutenbergEText;
	}
	 ...
	 */
	protected void setProjectGutenbergEText(final boolean newProjectGutenbergEText) {
		isProjectGutenbergEText = newProjectGutenbergEText;
	}
	...
	/**
	 * @return The ID of the work, or <code>null</code> if the ID is not known.
	 */
	 ...
	 */
	public void setReferenceURI(final URI newReferenceURI) {
	...
	/**
	 * @return The author of the work, or <code>null</code> if the author is not known.
	 */
	...
	/**
	 * @return The descrdiption of the work, or <code>null</code> if there is no description is not known.
	 */
	...
	/**
	 * @return The publisher of the work, or <code>null</code> if the publisher is not known.
	 */
	...
	/**
	 * @return The rights statement of the work, or <code>null</code> if the rights statement is not known known.
	 */
	 ...
	 */
	public void setRights(final String newRights) {
		rights = newRights;
	}
	...
	/**
	 * @return The location of a preface, or <code>null</code> if there should be no preface.
	 */
	public String getPrefaceLocation() {
		return prefaceLocation;
	}

	/**
	 * Sets the location of a preface.
	 * @param newPrefaceLocation The location of a preface, or <code>null</code> if there should be no preface.
	 */
	...
	/**
	 * @return The location of a title page, or <code>null</code> if there should be no title page.
	 */
	 ...
	 * @param newTitlePageLocation The location of a title page, or <code>null</code> if there should be no title page.
	 */
	...
	/**
	 * Sets the options that govern how OEB publication creation will occur. These options are used locally and are also passed to other objects such as
	 * <code>XMLSerializer</code>. The specific options passed are therefore not only applicable to the <code>OEBPublicationCreator</code> object, but may contain
	 * options meant for other classes used by this class. The options are copied before being stored, so changing the original properties later will not affect
	 * the behavior here.
	 * @param newOptions The options that govern how this class behaves, or <code>null</code> if options should be reset.
	 */
	...
	/**
	 * Searches a directory for relevant files and returns an OEB publication based on those files. Optionally tidies each OEB document and gathers all references
	 * to files.
	 * @param directory The base directory in which the publication files are located.
	 * @throws MalformedURLException Thrown if there is an error creating a URL from the directory.
	...
	/**
	 * Creates a publication with the given OEB file. Optionally tidies each OEB document and gathers all references to files.
	...
	/**
	 * Creates a publication with the given OEB document. Optionally tidies each OEB document and gathers all references to files. TODO why "optionally?"
	 * @param oebDocumentURL The URL to the OEB document which should be included in the publication.
	 * @param referenceURI The identifying URI of the publication.
	 * @param outputDir The output directory to use for writing files, or <code>null</code> if the default should be used.
	 * @return A new publication constructed from the OEB document.
	 * @throws MalformedURLException Thrown if there is an error creating a URL from the directory. TODO fix comment
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	public OEBPublication createPublicationFromOEBDocument(final URL oebDocumentURL, final URI referenceURI, final File outputDir) throws MalformedURLException,
			IOException {
	...
	/**
	 * Creates a publication from the given text document. The resulting OEB document is saved. Tidies each OEB document and gathers all references to files. If
	 * the file is a Project Gutenberg text file, it is processed as such, and the title and author propertiers, if located, are added as metadata.
	 * @param textURL The URL to the tetx document which should be included in the publication.
	 * @param referenceURI The identifying URI of the publication.
	 ...
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	public OEBPublication createPublicationFromText(final URL textURL, URI referenceURI, final Charset charset, final File outputDir) throws URISyntaxException,
		...
		if(pgHeaderFragment != null) { //if we have a Project Gutenberg header, write it to its own file
			...
			final Element headerElement = XML.createElementNS(pgHeaderDocument, bodyElement.getNamespaceURI(), ELEMENT_H2,
					"Information from the Original Project Gutenberg EText"); //TODO use a constant
	...
	/**
	 * Searches a directory for relevant files and returns an OEB publication based on those files.
	 * @param publication The publication to which the manifest items should be added.
	 * @param directory The base directory in which the publication files are located.
	 * @throws MalformedURLException Thrown if there is an error creating a URL for an item.
	 * @throws IOException Thrown if there is an error reading files from the directory.
	 */
	...
	/**
	 * Iterates through the manifest items, optionally tidies the document, and gathers references.
	 * @param publication The publication whose manifest documents should be processed.
	 * @see #isTidy
	 * @throws MalformedURLException Thrown if there is an error creating a URL from an item.
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	 ...
	 * @see #isTidy
	 * @throws MalformedURLException Thrown if there is an error creating a URL from the item.
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	...
	/**
	 * Searches through an OEB document and retrieves the items that should go in the manifest. This includes embedded images, applets, and local link targets.
	 ...
	 * @param itemDocument The document to be searched for references. This object should also implement the <code>DocumentTraversal</code> interface.
	...
	/**
	 * Adds a particular reference with an unknown media type to the publication manifest if it doesn't exist there already. Only references to files local to the
	 * publication will be added.
	 * @param publication The publication to which the item belongs.
	 * @param contextURL The URL to which the href is relative.
	 * @param href The reference to the item.
	 * @return The item created to represent the reference or the item that already appeared in the manifext, or <code>null</code> if the item was not added and
	 *         did not already appear in the manifest. TODO fix outputDir
	 * @throws URISyntaxException Thrown if an invalid reference was discovered.
	 * @throws MalformedURLException Thrown if a an invalid reference is discovered.
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	protected RDFResource gatherReference(final OEBPublication publication, final URL contextURL, final String href) throws URISyntaxException,
			MalformedURLException, IOException {
		return gatherReference(publication, contextURL, href, null); //gather the reference without specifying a media type
	}

	/**
	 * Adds a particular reference to the publication manifest, if it doesn't exist there already. Only references to files local to the publication and files
	 * that are not above the publication URL in the directory hierarchy will be added.
	 * @param publication The publication to which the item belongs.
	 * @param contextURL The URL to which the href is relative.
	 * @param href The reference to the item.
	 * @param mediaType The reference media type, if known, or <code>null</code> if the media type is undetermined.
	 * @return The item created to represent the reference or the item that already appeared in the manifext, or <code>null</code> if the item was not added and
	 ...
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	protected RDFResource gatherReference(final OEBPublication publication, final URL contextURL, final String href, ContentType mediaType)
	 ...
	 * @param contextURL The URL to which the href is relative.
	 * @param href The reference to the item.
	 * @param shouldAddToSpine Whether the reference should be added to the spine as well.
	 * @return The item created to represent the reference or the item that already appeared in the manifext, or <code>null</code> if the item was not added and
	 *         did not already appear in the manifest. TODO fix outputDir
	 * @throws URISyntaxException Thrown if an invalid reference was discovered.
	 * @throws MalformedURLException Thrown if a an invalid reference is discovered.
	 * @throws IOException Thrown if there is an error reading or writing to a file.
	 */
	protected RDFResource gatherReference(final OEBPublication publication, final URL contextURL, final String href, final boolean shouldAddToSpine)
			throws URISyntaxException, MalformedURLException, IOException {
	 ...
	 */
	protected RDFResource gatherReference(final OEBPublication publication, final URL contextURL, final String href, ContentType mediaType,
			final boolean shouldAddToSpine) throws URISyntaxException, MalformedURLException, IOException {
	...
	/**
	 * Checks to make sure the given OEB item has a supported MIME type. If not, a fallback item is searched for. TODO add capability to convert .gif to .png
	 * Currently, the following items are checked:
	 * <ul>
	 * <li>GIF files are given PNG fallback items of the same name, if such PNG files exist.</li>
	 * </ul>
	 * @param publication The publication to which the item belongs.
	 * @param oebItem The item being processed.
	 */
	...
	/**
	 * Tidies an OEB file and adds any stylesheet references. Internal stylesheets may be extracted and stored in a separate file, and other parts of the
	 * document, such as tables of content, may be likewise extracted and stored as separate files.
	...
	/**
	 * Extracts all elements that contain a certain class attribute and returns all elements and their interspersed nodes as a document fragment.
	 * @param itemDocument The document from which the elements should be extracted.
	 * @param classSubstring Represents a substring to match (case insensitive) the class attribute of the elements to extract.
	 * @return A document fragment containing the extracted elements and all interspersed nodes.
	 */
	...
	/**
	 * Searches a document for all links that are internal (i.e. begin with '#') and converts them to external links to the specified external reference,
	 * correctly retaining the internal link to the new references. This is useful if a fragment of a document has been extracted from the original document
	 * &mdash; the external reference would then be a reference to the original document.
	 * @param document The document to check. This object should also implement the <code>DocumentTraversal</code> interface.
	 * @param externalHRef The external reference, without any fragment, to the new document.
	 * @see DocumentTraversal
	 */
	 ...
	 * @param publication The OEB publication to which the guides references will be added.
	...
	/**
	 * Loads the given template, does replacements, and copies the template to the appropriate location.
	 * @param templateURL The location of the template.
	 * @return The URL of the formatted template copy.
	 * @throws IOException Thrown if there is an error accessing or copying the template.
	 */
	@Deprecated
	//TODO fix; currently throws an unsupported operation exception
	protected URL useTemplate(final URL templateURL) throws IOException {
		...
		final String title = getTitle() != null ? getTitle() //get the title if we can
				: (filename != null ? filename //if not, use the filename if we can
		...
		final String formattedString = MessageFormat.format(templateString,
				new Object[] { XML.createValidContent(title), XML.createValidContent(author), XML.createValidContent(by), XML.createValidContent(infoURL) }); //TODO use constants
	...
	/**
	 * Creates a reference URI of an item from the given href and URI of the publication.
	...
	/**
	 * Tries to determine the title from the the first few elements of the XHTML document.
		...
		for(int i = 0; i < 25 && i < childNodes.getLength(); ++i) { //look at each child node
			...
			if(childNode.getNodeType() == Node.ELEMENT_NODE) { //if this is an element
				...
				if(Strings.indexOfIgnoreCase(text, "Michael S. Hart") < 0 //TODO these are last-minute hacks specifically for plboss10.txt
						&& Strings.indexOfIgnoreCase(text, "405 West") < 0 && Strings.indexOfIgnoreCase(text, "Urbana, IL") < 0) {
					...
					if(CharSequences.containsLetter(text) && (CharSequences.isUpperCase(text) || Prose.isTitleHeading(text))) { //TODO probably put this routine in some common area
	...
	/**
	 * Tries to determine the author from the the first few elements of the XHTML document.
			...
			if(childNode.getNodeType() == Node.ELEMENT_NODE) { //if this is an element
				...
				while(byIndex >= 0) { //if we found "by"
					...
					if((byIndex == 0 || Characters.isWhitespace(text.charAt(byIndex - 1)))
							&& (byIndex + BY.length() == text.length() || (byIndex + BY.length() < text.length() && Character
									.isWhitespace(text.charAt(byIndex + BY.length()))))) { //if there is whitespace after "by"
						if(BY.equalsIgnoreCase(text.trim())) { //if this is just "by" by itself
							...
							final String[] UNACCEPTABLE_BY_PREFIXES = { "donated", "contributed", "created", //TODO use constants
									"delimited", "etext", "prepared", "proofread", "scanned", "typed in", "made available" };
