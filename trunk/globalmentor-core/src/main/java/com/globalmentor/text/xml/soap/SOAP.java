...
public class SOAP {
	...
	/**
	 * Creates a SOAP message and transfers information from the first-level child trees of the given XML document. The document element of the XML document is
	 * ignored.
	...
	/**
	 * Creates a SOAP message containing a SOAP fault element from the given exception.
	 * @param genericFaultCode One of generic SOAP fault codes.
	 * @param exception The exception to convert to a SOAP fault.
	 * @param messageFactory The message factory to use when creating SOAP messages.
	 * @return The SOAP message containing the fault object created from the given exception.
	 * @see #createSOAPFault
	 */
	...
	/**
	 * Creates a SOAP fault element from the given exception and adds it to the given SOAP body. The exception name will be used to construct a fault code in the
	 * form "genericFaultCode.exceptionName".
	...
	/**
	 * Converts all first-level child trees of the given document to SOAP elements and stores them in the SOAP body of the given SOAP envelope. The document
	 * element of the XML document is ignored.
	...
	/**
	 * Converts all first-level child trees of the given document to SOAP elements and stores them in the given SOAP body. The document element of the XML
	 * document is ignored.
	...
	/**
	 * Converts all first-level child trees of the given document to SOAP elements and stores them in the SOAP header of the given SOAP envelope. The document
	 * element of the XML document is ignored.
	...
	/**
	 * Converts all first-level child trees of the given document to SOAP elements and stores them in the given SOAP header. The document element of the XML
	 * document is ignored.
	...
	/**
	 * Converts a DOM element to a SOAP element and stores it as a child of the given parent SOAP element.
	 ...
	 * @param soapEnvelope The SOAP envelope to be used as a name factory.
	 * @return The SOAP element constructed with the information from the DOM element. //TODO add SOAP and DOM exception reporting documentation
	 */
	 ...
	 * @return The DOM element constructed with the information from the SOAP body element. //TODO add SOAP and DOM exception reporting documentation
	 */
	 ...
	 * @param soapEnvelope The SOAP envelope to be used as a name factory and in which the SOAP body is located.
	 * @param domImplementation The DOM implementation to use as a document factory.
	 * @return The DOM element constructed with the information from the SOAP body element. //TODO add SOAP and DOM exception reporting documentation
	 */
	 ...
	 * @param domImplementation The DOM implementation to use as a document factory.
	 * @return The DOM element constructed with the information from the SOAP header element. //TODO add SOAP and DOM exception reporting documentation
	 */
	 ...
	 * @param soapEnvelope The SOAP envelope to be used as a name factory and in which the SOAP header is located.
	 * @param domImplementation The DOM implementation to use as a document factory.
	 * @return The DOM element constructed with the information from the SOAP header element. //TODO add SOAP and DOM exception reporting documentation
	 */
	 ...
	 * @param domImplementation The DOM implementation to use as a document factory.
	 * @param soapEnvelope The SOAP envelope to be used as a name factory.
	 * @return The DOM element constructed with the information from the SOAP element. //TODO add SOAP and DOM exception reporting documentation
	 */
	...
	/**
	 * Converts a SOAP element to a DOM element and stores it as a child of the given parent DOM element.
	...
	public static Element createElement(final SOAPElement soapElement, final Element parentElement, final SOAPEnvelope soapEnvelope) {
		...
		final Element element = parentElement.getOwnerDocument().createElementNS(soapElement.getElementName().getURI(),
		...
		while(attributeIterator.hasNext()) { //while there are more attributes
			...
			element.setAttributeNS(attributeName.getURI().length() > 0 ? attributeName.getURI() : null, attributeName.getQualifiedName(), attributeValue);
		}
	...
	/**
	 * Converts a SOAP message to a string. If an error occurs converting the message to a string, the normal object string will be returned.
