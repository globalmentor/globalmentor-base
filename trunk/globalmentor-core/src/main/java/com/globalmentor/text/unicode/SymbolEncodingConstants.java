...
/**Contains constants for mapping the Adobe Symbol font to Unicode.
	Implemented by referencing "Encoding Symbol Font" table provided by
	Oscar van Vlijmen (<a href="mailto:o.van.vlijmen@tip.nl">o.van.vlijmen@tip.nl)</a>
...
public class SymbolEncodingConstants
{
	...
	/**A map of Unicode characters stored at the symbol font indexes. Conversion
		from the symbol font to Unicode is be performed using:
		<code>unicodeChar=SYMBOL_FONT_TO_UNICODE_TABLE[symbolChar];</code>
		<p>Note that several characters are not completely encoded; their complete
		representation, as given by Oscar van Vlijmen's table, are as follows:</p>
		<ul>
	...
	*/
	public final static char[] SYMBOL_FONT_TO_UNICODE_TABLE=
	{
