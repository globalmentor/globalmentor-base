 ...
 * href="mailto:o.van.vlijmen@tip.nl">o.van.vlijmen@tip.nl)</a> at <a
 * href="http://www.tip.nl/users/o.van.vlijmen/charsets.html">http://www.tip.nl/users/o.van.vlijmen/charsets.html</a>.
 * @author Garret Wilson
 */
public class SymbolEncodingConstants {

	/**
	 * A map of Unicode characters stored at the symbol font indexes. Conversion from the symbol font to Unicode is be performed using:
