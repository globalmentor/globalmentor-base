...
public class Prose {
	...
	*/
	 ...
	 * </ul>
	 * <p>
	 * The following type of headings is recognized by its containing only the characters '*' and/or '-', or the string "page" after punctuation is removed, and
	 * appears only on a single line:
	 * </p>
	 * <ul>
	 * <li><code>PAGE_BREAK_HEADING</code></li>
	 * </ul>
	 * @param text The text to check for heading type.
	 * @return The type of heading, or <code>NO_HEADING</code> if the heading could not be determined.
	 ...
	 * </p>
	 * <ul>
	 * <li>Text comprised solely of the following characters: '*', '-', '_', em-dash, and/or en-dash.</li>
	...
	public static boolean isBreak(final String text) {
		...
		//if this line contains "page" surrounded by only punctuation
			...
			//if this is not a page break heading
			return false; //show that we don't think this is a page break heading
	}

	/**
	 * Determines if the given text is a page number. A page number appears on a single line and has a page indicator and a number, along with an optional select
	 * set of symbols but no other letters.
	 * @param text The text to check.
	...
	/**
	 * Determines if the given text is a subheading. A subheading is in all uppercase, is not composed completely of digits, and is not surrounded by quotation
	 * marks.
	 * @param text The text to check.
	 ...
	 * @return <code>true</code> if the given text contains the required labels and only the required and optional labels.
	 */
	 ...
	 * @return <code>true</code> if the string's first or last non-whitespace character is some sort of quotation mark.
	 */
