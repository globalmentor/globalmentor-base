...
public class Java
{
	...
	*/ 
	...
	<p>All callers from this class are ignored to allow for the various convenience forms of this method.</p>
	...
	*/
	...
	<p>All callers from this class are ignored to allow for the various convenience forms of this method.</p>
	@param ignoreClass The class to ignore in the stack, or <code>null</code> if the first caller before this method's caller should be returned and no other classes should be ignored.
	...
	@throws IllegalArgumentException if an ignore class was provided and there was no caller in the stack before the caller to this method that wasn't from the given class.
	*/
	...
	*/
	...
	<p>All callers from this class are ignored to allow for the various convenience forms of this method.</p>
	@param ignoreClass The class to ignore in the stack, or <code>null</code> if the first caller before this method's caller should be returned and no other classes should be ignored.
	@return A stack trace element representing the last line of program execution before a method in the class of the caller to this method, skipping the ignore class, if any.
	@throws IllegalStateException if no ignore class was provided and there was no caller in the stack before the caller to this method.
	@throws IllegalArgumentException if an ignore class was provided and there was no caller in the stack before the caller to this method that wasn't from the given class.
	*/
	public static StackTraceElement getCallingClassStackTraceElement(final Class<?> ignoreClass)
	{
		...
		int i;
		for(i=0; i<stackLength && thisClassName.equals(stack[i].getClassName()); ++i);	//skip all the callers from this class
