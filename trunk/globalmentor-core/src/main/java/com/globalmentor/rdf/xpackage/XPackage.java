...
public class XPackage {
	...
	/**
	 * Adds an <code>&lt;xpackage:location&gt;</code> property to the resource. The link will be set to <code>xlink:type="simple"</code>.
	 * @param resource The resource to which a property should be added.
	 * @param href The location of the resource, to become an <code>xlink:href</code> property of the location property.
	...
	/**
	 * Sets the <code>xpackage:location</code> property to the resource. The link will be set to <code>xlink:type="simple"</code>.
	 * @param resource The resource to which a property should be added.
	 * @param href The location of the resource, to become an <code>xlink:href</code> property of the location property.
	 * @return The new location resource.
	 */
	 ...
	 * @return A newly created default XPackage package description document with an RDF section.
	 */
	public static Document createDefaultXPackageDocument(final DOMImplementation domImplementation) {
		...
		final Document document = domImplementation.createDocument(XPACKAGE_NAMESPACE_URI.toString(),
				XML.createQName(XPACKAGE_NAMESPACE_PREFIX, ELEMENT_DESCRIPTION), null);
		...
		descriptionElement.setAttributeNS(XML.XMLNS_NAMESPACE_URI.toString(), XML.createQName(XML.XMLNS_NAMESPACE_PREFIX, RDF_NAMESPACE_PREFIX),
				RDF_NAMESPACE_URI.toString());
		//add the XPackage namespace declaration prefix, xmlns:xpackage
		descriptionElement.setAttributeNS(XML.XMLNS_NAMESPACE_URI.toString(), XML.createQName(XML.XMLNS_NAMESPACE_PREFIX, XPACKAGE_NAMESPACE_PREFIX),
				XPACKAGE_NAMESPACE_URI.toString());
		//add the XLink namespace declaration prefix, xmlns:xlink
		descriptionElement.setAttributeNS(XML.XMLNS_NAMESPACE_URI.toString(), XML.createQName(XML.XMLNS_NAMESPACE_PREFIX, XLink.XLINK_NAMESPACE_PREFIX),
				XLink.XLINK_NAMESPACE_URI.toString());
	...
	/**
	 * Creates an object that will appropriately generate an XPackage-compliant XML representation of RDF data models. The created <code>RDFXMLifier</code> will
	 * be initialized to encode properties from the XLink namespace as XML attributes, for example.
	...
	/**
	 * Retrieves the icon URI of the resource. If this resource has more than one property of <code>xpackage:icon</code>, it is undefined which of those property
	...
	/**
	 * Returns an item resource in the given RDF list that has a matching xpackage:location with an xlink:href that matches the requested href, relative to the
	 * given URI.
	 * @param list The list of RDF resources.
	 * @param baseURI The base URI of the package, used to construct absolute URIs from relative URIs.
	 * @param href The relative or absolute reference to the item, which will be converted to an absolute URI in order to compare it with each item's fully
	 *          qualified URI.
	 * @return The item whose fully qualified URI matches the fully qualified version of the specified href, or <code>null</code> if there is no match.
	 * @see #getLocationHRef
	 */
	...
	/**
	 * Returns an item resource in the given RDF list that has a matching xpackage:location with an xlink:href that matches the requested URI, relative to the
	 * given base URI.
	 * @param list The list of RDF resources.
	 * @param baseURI The base URI of the package, used to construct absolute URIs from relative URIs.
	 * @param uri The absolute reference to the item, which will be compare with each item's fully qualified URI.
	 * @return The item whose fully qualified URI matches the given URI, or <code>null</code> if there is no match.
	 * @see #getLocationHRef
	 */
	...
	/**
	 * Returns an item resource in the manifest of the given resource, if present, that has a matching xpackage:location with an xlink:href that matches the
	...
	*/
	...
	/**
	 * Returns an item resource in the manifest of the given resource, if present, that has a matching xpackage:location with an xlink:href that matches the
	 * requested URI, relative to the given base URI.
	 * @param resource The resource the manifest of which should be searched.
	 * @param baseURI The base URI of the package, used to construct absolute URIs from relative URIs.
	 * @param uri The absolute reference to the item, which will be compare with each item's fully qualified URI.
	 * @return The item whose fully qualified URI matches the given URI, or <code>null</code> if there is no match.
	...
	*/
	...
	/**
	 * Returns an item resource in the given RDF container that has a matching xpackage:location with an xlink:href that matches the requested URI, relative to
	 * the given base URI.
	...
	*/
	...
	/**
	 * Retrieves the location resource of the resource. If this resource has more than one property of <code>xpackage:location</code>, it is undefined which of
	 * those property values will be returned.
	 * @param resource The resource the manifest of which will be returned.
	 * @return The location of the resource, or <code>null</code> if no location property exists.
	 * @throws ClassCastException Thrown if the location is not a resource (an XPackage location should never be a literal).
	 */
	...
	/**
	 * Retrieves the location href of the resource, which is the literal href property of the location property resource. If this resource has more than one
	 * property of <code>xpackage:location</code>, it is undefined which of those properties will be used.
	 * @param resource The resource the manifest of which will be returned.
	 * @return The location href of the resource, or <code>null</code> if no location property exists, or if the location has no href.
	 * @throws ClassCastException Thrown if the location is not a resource (an XPackage location should never be a literal) or if the href is not a literal.
	 */
