...
public class ReverseIterator<E> implements Iterator<E> {
	...
	/**
	 * Iterable constructor. A temporary collection will be created and filled with the contents of the given iterable unless the given iterable is a {@link List}
	 * .
	...
	/**
	 * List iterator constructor. The list list iterator will be placed at the end of the list. For added efficiency, the decorated list iterator should already
	...
	/**
	 * Returns a list iterator to the given iterable. The list iterator will be placed at the end of the elements for efficiency. If the given iterable is not a
	 * {@link List}, a temporary list will be created and filled with the contents of the given iterable.
	...
	/**
	 * Returns <code>true</code> if the iteration has more elements. This implementation delegates to the decorated iterator's opposite method,
	...
	/**
	 * Returns the next element in the iteration. This implementation delegates to the decorated iterator's opposite method, {@link ListIterator#previous()}.
	...
	/**
	 * Removes from the underlying collection the last element returned by the iterator (optional operation). This implementation delegates to the decorated
	 * iterator's {@link ListIterator#remove()} method.
	 * @throws UnsupportedOperationException if the {@link #remove()} operation is not supported by this iterator.
	 * @throws IllegalStateException if the {@link #next()} method has not yet been called, or the {@link #remove()} method has already been called after the last
