...
<p><strong>This class is <em>not</em> a general-purpose {@link Set}
	implementation!  While this class implements the {@link Set} interface,
	it intentionally violates {@link Set}'s general contract, which mandates
	the use of the {@link Object#equals(Object)} method when comparing objects.  This
	class is designed for use only in the rare cases wherein reference-equality
	semantics are required.</strong></p>
<p>This class is based upon {@link HashSet} 1.28, 01/23/03 by 
