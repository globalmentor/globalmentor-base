...
/**Sorts resources based upon content created date.
...
public class ResourceContentCreatedComparator extends AbstractSortOrderComparator<URFResource>
{
	...
	*/
	...
	<p>This implementation compares resources based upon content created date.
	...
	*/
	public int compare(final URFResource resource1, final URFResource resource2)
	{
		...
		return Comparables.compare(getCreated(resource1), getCreated(resource2), getSortOrder());	//compare created dates
	}
