...
public class URFTURFGenerator
{
	...
	public TURFNamespaceLabelManager getNamespaceLabelManager()
	{
		return namespaceLabelManager;
	}

	/**
	 * The set of URIs of named resources that have been generated; keep separate sets of named and non-named resources because some anonymous resource equals()
	 * methods may not use identity, which we need.
	 */
	...
	protected final void setGenerated(final URFResource resource, final boolean generated)
	{
		...
		if(resourceURI != null) //if this resource has a URI
		{
			...
			//if the resource has not been generated
			{
	...
	/**
	 * Retrieves a label appropriate for the given resource, creating one if necessary. If the resource has already been assigned a label, it will be returned;
	 * otherwise, a new label will be generated. For namespace URI resources, a namespace label will be generated
	 * @param resource The resource for which a label should be returned.
	...
	/**
	 * Indicates whether formatted output uses the list delimiter in addition to newlines. This option is set to <code>true</code> by default.
	 * @return Whether formatted output uses the list delimiter in addition to newlines.
	 */
	public boolean isFormattedListDelimiter()
	{
		return formattedListDelimiter;
	}
	 ...
	 */
	public void setFormattedListDelimiter(final boolean formattedListDelimiter)
	{
		this.formattedListDelimiter = formattedListDelimiter;
	}
	...
	public boolean isPropertyNamespacePrefixesForced()
	{
		return propertyNamespacePrefixesForced;
	}

	/**
	 * Sets whether namespace prefixes are always used for property resources not in the default namespace. If a container is generated, this implies that all
	 * property resources will receive a namespace prefix association, regardless of the number of times that namespace is used. If a container is generated, this
	 * means that property resource will be generated using prefixes that have no explicit namespace association; this is usually useful only for human
	 * consumption.
	 ...
	 */
	public void setPropertyNamespacePrefixesForced(final boolean propertyNamespacePrefixesForced)
	{
		this.propertyNamespacePrefixesForced = propertyNamespacePrefixesForced;
	}
	...
	public boolean isShortInterfacesGenerated()
	{
		return shortInterfacesGenerated;
	}
	 ...
	 */
	public void setShortInterfacesGenerated(final boolean shortInterfacesGenerated)
	{
		this.shortInterfacesGenerated = shortInterfacesGenerated;
	}
	...
	public boolean isShortTypesGenerated()
	{
		return shortTypesGenerated;
	}
	 ...
	 */
	public void setShortTypesGenerated(final boolean shortTypesGenerated)
	{
		this.shortTypesGenerated = shortTypesGenerated;
	}
	...
	public boolean isShortCommunitiesGenerated()
	{
		return shortCommunitiesGenerated;
	}
	 ...
	 */
	public void setShortCommunitiesGenerated(final boolean shortCommunitiesGenerated)
	{
		this.shortCommunitiesGenerated = shortCommunitiesGenerated;
	}
	...
	public boolean isShortPropositionsGenerated()
	{
		return shortPropositionsGenerated;
	}
	 ...
	 */
	public void setShortPropositionsGenerated(final boolean shortPropositionsGenerated)
	{
		this.shortPropositionsGenerated = shortPropositionsGenerated;
	}
	...
	public boolean isShortListsGenerated()
	{
		return shortListsGenerated;
	}
	 ...
	 */
	public void setShortListsGenerated(final boolean shortListsGenerated)
	{
		this.shortListsGenerated = shortListsGenerated;
	}
	...
	public boolean isShortMapsGenerated()
	{
		return shortMapsGenerated;
	}
	 ...
	 */
	public void setShortMapsGenerated(final boolean shortMapsGenerated)
	{
		this.shortMapsGenerated = shortMapsGenerated;
	}
	...
	public boolean isShortSetsGenerated()
	{
		return shortSetsGenerated;
	}
	 ...
	 */
	public void setShortSetsGenerated(final boolean shortSetsGenerated)
	{
		this.shortSetsGenerated = shortSetsGenerated;
	}
	...
	public boolean isShortSuperclassesGenerated()
	{
		return shortSuperclassesGenerated;
	}
	 ...
	 */
	public void setShortSuperclassesGenerated(final boolean shortSuperclassesGenerated)
	{
		this.shortSuperclassesGenerated = shortSuperclassesGenerated;
	}
	...
	/**
	 * Creates a formatted TURF generator for human-consumable printing. The generated TURF may not be machine processable and abbreviations may be used without
	 * rigorous definitions.
	 * @return A TURF generator for printing.
	 */
	public static URFTURFGenerator forPrint()
	{
		return forPrint(true);
	}

	/**
	 * Creates a TURF generator for human-consumable printing. The generated TURF may not be machine processable and abbreviations may be used without rigorous
	 * definitions.
	 * @param baseURI The base URI of the URF data model, or <code>null</code> if the base URI is unknown.
	 * @return A TURF generator for printing.
	 */
	public static URFTURFGenerator forPrint(final URI baseURI)
	{
		return forPrint(baseURI, true);
	}
	 ...
	 * @return A TURF generator for printing.
	 */
	public static URFTURFGenerator forPrint(final boolean formatted)
	{
		return forPrint(null, formatted);
	}
	 ...
	 * @return A TURF generator for printing.
	 */
	public static URFTURFGenerator forPrint(final URI baseURI, final boolean formatted)
	{
		final URFTURFGenerator urfTURFGenerator = new URFTURFGenerator(baseURI);
		urfTURFGenerator.setFormatted(formatted);
	...
	/**
	 * Generates all the resources within a given data model. A TURF container will be generated to contain the generated resources.
	...
	/**
	 * Generates the given resources and all related resources. A TURF container will be generated to contain the generated resources.
	 * @param appendable The appendable used for generating the information.
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	public <A extends Appendable> A generateResources(final A appendable, final boolean generateContainer, final Iterable<URFResource> resources)
			throws IOException
	{
		final URF urf = new URF(); //create a new URF data model
	...
	/**
	 * Generates all the resources within a given data model, indicating an optional resource that should appear first. A TURF container will be generated to
	 * contain the generated resources.
	 * @param appendable The appendable used for generating the information.
	 * @param urf The data model of which resources should be generated.
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	public <A extends Appendable> A generateResources(final A appendable, final URF urf, final boolean generateContainer, final URFResource primaryResource)
			throws IOException
	{
		...
		if(generateContainer) //if we should generate a container
		{
			...
			for(final Map.Entry<URFResource, Set<URFScope>> objectReferenceMapEntry : referenceSummary.objectReferenceMap.entrySet())//look at each resource and the number of references it has
			{
				...
				if(resourceURI != null && !SHORT_REFERENCE_CLASS_URIS.contains(resourceURI)) //if this resource has a URI (if not, it has no namespace) and it doesn't identify a type that will receive a short reference (such URIs will never show up in normal circumstances)
				{
					...
					if(namespaceURI != null && !isInlineNamespaceURI(namespaceURI)) //if this resource URI has a namespace that isn't an inline namespace (URIs in inline namespaces have their own short forms)
					{
						...
						//if this resource is only referenced once or not at all (for the root resource)
						{
			...
			for(final Map.Entry<URI, Set<URFScope>> propertyURIReferenceMapEntry : referenceSummary.propertyURIReferenceMap.entrySet())//look at each resource and the number of references it has
			{
				...
				if(namespaceURI != null && !isInlineNamespaceURI(namespaceURI)) //if this property URI has a namespace that isn't an inline namespace (URIs in inline namespaces have their own short forms)
				{
					...
					//if we're not forcing property namespaces, see if there are enough namespace occurrences to warrant a prefix
					{
						...
						//if this property URI is only used once or not at all
						{
							final Boolean hasMultipleReferences = namespaceURIMultipleMap.get(namespaceURI); //see whether there are multiple references to this namespace
							if(hasMultipleReferences == null) //if we haven't seen this namespace URI before
							{
			...
			for(final Map.Entry<URI, Boolean> namespaceURIMultipleEntry : namespaceURIMultipleMap.entrySet()) //for each namespace URI entry
			{
				...
				if(Boolean.TRUE.equals(namespaceURIMultipleEntry.getValue()) || namespaceLabelManager.isRecognized(namespaceURI))
				{
					...
					//if we haven't started the properties, yet
					{
	...
	/**
	 * Generates a single top-level resource, prepending a list delimiter if appropriate. The resource is noted as having been generated.
	 * @param appendable The appendable used for generating the information.
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	protected <A extends Appendable> A generateRootResource(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary,
			final URFResource resource) throws IOException
	{
	...
	/**
	 * Generates a single resource. The resource is noted as having been generated.
	 * @param appendable The appendable used for generating the information.
	 * @param urf The URF data model.
	 * @param referenceSummary A summary of scope references to resources and property URIs.
	 * @param resource The resource to generate.
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	protected <A extends Appendable> A generateResource(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary, final URFResource resource)
			throws IOException
	{
	...
	/**
	 * Generates a single resource with no default namespace URI. The resource is noted as having been generated.
	 * @param appendable The appendable used for generating the information.
	 * @param urf The URF data model.
	 * @param referenceSummary A summary of scope references to resources and property URIs.
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	protected <A extends Appendable> A generateResource(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary,
			final URFScope subjectScope, final URI scopePropertyURI, final URFResource resource, final boolean inSequence) throws IOException
	{
		...
		for(final URFResource type : resource.getTypes()) //look through all the types
		{
			...
			//if this is not one of the short types addressed here
			{
				hasNonListType = true; //there is a non-list type
				hasNonSetType = true; //there is a non-set type
				hasNonMapType = true; //there is a non-map type
		...
		//if this is not a proposition short form
		{
		...
		final boolean isMapShortForm = isShortMapsGenerated()
				&& (isMap || (resource.hasProperty(ENTRY_PROPERTY_URI) && (hasNonMapType || isListShortForm || isSetShortForm))); //generate a map short form if this is a map or it has entry properties (but only if there is some other type; otherwise, it would introduce a map type where none was specified)
		//type
			...
			for(final URFProperty typeProperty : resource.getProperties(TYPE_PROPERTY_URI)) //look at each type
			{
				...
				if(typeURI != null) //if the given type has a URI
				{
					...
					if(selector != null) //if there is a selector for this type
					{
						...
						generateCollection(appendable, urf, referenceSummary, selector.getNamespaceProperties(ORDINAL_NAMESPACE_URI).iterator(), SELECTOR_BEGIN,
								SELECTOR_END, false); //generate all the values of ordinal properties in the selector list on the same line
					}
				}
		...
		propertyCount = generateProperties(appendable, urf, referenceSummary, resource, false, propertyCount, !isShortTypesGenerated,
				!isShortSuperclassesGenerated, !isShortInterfacesGenerated, !isPropositionShortForm, !isListShortForm, !isSetShortForm, !isMapShortForm, true); //generate properties
		if(subjectScope != null && scopePropertyURI != null) //if this resource is the value of a property
		{
			final URFScope scope = subjectScope.getScope(scopePropertyURI, resource); //get the scope for this value
			if(scope == null) //if there is no such scope
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	protected <A extends Appendable> A generateCollection(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary,
			final Iterator<URFProperty> elementPropertyIterator, final char collectionBegin, final char collectionEnd, final boolean multipleLines)
			throws IOException
	{
		if(elementPropertyIterator.hasNext()) //if there are elements in the collection
		{
			...
			while(elementPropertyIterator.hasNext()) //while there are elements
			{
				...
				generateResource(appendable, urf, referenceSummary, elementProperty.getSubjectScope(), elementProperty.getPropertyURI(), elementProperty.getValue(),
						false); //generate the element; each element value is an object of the element predicate, so use the element property URI as the context
	 ...
	 * @exception IOException if there is an error writing to the appendable.
	 */
	protected <A extends Appendable> A generateMap(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary,
			final Iterator<URFProperty> entryPropertyIterator, final char mapBegin, final char mapEnd, final boolean multipleLines) throws IOException
	{
		...
		//if there are no entries in the map
		{
	...
	/**
	 * Generates the properties, if any, of a given scope. The beginning property section delimiter will be added if needed, but no ending property section
	 * delimiter will be generated.
	 * @param appendable The appendable used for generating the information.
	 * @param urf The URF data model.
	 * @param referenceSummary A summary of scope references to resources and property URIs.
	 ...
	 * @param generateOrder Whether the order property should be generated; if order properties are not generated, their values will be marked at generated if
	 *          they have no other properties needed to be generated.
	 ...
	 */
	protected <A extends Appendable> int generateProperties(final A appendable, final URF urf, final URF.ReferenceSummary referenceSummary, final URFScope scope,
			final boolean scoped, int propertyCount, final boolean generateTypes, final boolean generateSuperclasses, final boolean generateInterfaces,
			final boolean generateProposition, final boolean generateOrdinals, final boolean generateElements, final boolean generateEntries,
			final boolean generateOrder) throws IOException
	{
		...
		for(final URFProperty property : scope.getProperties()) //look at each property
		{
			...
			if((!generateTypes && TYPE_PROPERTY_URI.equals(propertyURI)) //if we shouldn't generate types and this is a type
					...
					|| (!generateProposition && (SUBJECT_PROPERTY_URI.equals(propertyURI) || PREDICATE_PROPERTY_URI.equals(propertyURI) || OBJECT_PROPERTY_URI
							.equals(propertyURI))) //or if we shouldn't generate proposition properties and this property is a subject, predicate, or object
			...
			if(sequencePropertyURI == null) //if we're not in the middle of a sequence
			{
				...
				//if we haven't yet started the properties section
				{
				...
				//if this property has no sequence
				{
			...
			//if we are still in the middle of a sequence
			{
	...
	/**
	 * Creates and returns a reference string to a resource with the given URI. A name reference or short form will be used if appropriate. No prefix will be
	 * determined if one is not already available for the namespace URI, if any, of the given resource URI.
	...
	/**
	 * Creates and returns a reference string to a resource with the given URI. A name reference or short form will be used if appropriate.
	 * @param uri The URI of the resource.
	 * @param namespaceLabelManager The manager responsible for generating namespace labels if needed.
	 * @param baseURI The base URI of the URF data model, or <code>null</code> if the base URI is unknown.
	...
	/**
	 * Generates a reference to a resource with the given URI with no default namespace URI. A name reference or short form will be used if appropriate. If a
	 * reference to an inline URI is generated, the corresponding inline type URI will be marked as generated if it has no other qualities needed to be generated
	 * separately. No prefix will be determined if one is not already available for the namespace URI, if any, of the given resource URI.
	 * @param appendable The appendable used for generating the information.
	 * @param urf The URF data model.
	 * @param uri The URI of the resource.
	...
	/**
	 * Generates a reference to a resource with the given URI. A name reference or short form will be used if appropriate.
	 * @param appendable The appendable used for generating the information.
	 * @param uri The URI of the resource.
	 * @param namespaceLabelManager The manager responsible for generating namespace labels if needed.
	 * @param baseURI The base URI of the URF data model, or <code>null</code> if the base URI is unknown.
	 ...
	 * @see #generateURIReference(Appendable, URI, TURFNamespaceLabelManager, URI, URI)
	 */
	public static <A extends Appendable> URI generateReference(final A appendable, final URI uri, final TURFNamespaceLabelManager namespaceLabelManager,
			final URI baseURI, final boolean determinePrefix) throws IOException
	{
		...
		if(isInlineURI(uri)) //if this URI is in an inline namespace
		{
			...
			else if(DATE_CLASS_URI.equals(inlineTypeURI) || DATE_TIME_CLASS_URI.equals(inlineTypeURI) || DURATION_CLASS_URI.equals(inlineTypeURI)
					|| TIME_CLASS_URI.equals(inlineTypeURI) || UTC_OFFSET_CLASS_URI.equals(inlineTypeURI)) //if this is a temporal
			{
		...
		if(namespaceURI != null) //if there is a namespace
		{
			...
			final String prefix = suppressPrefix ? null : (determinePrefix ? namespaceLabelManager.determineNamespaceLabel(namespaceURI) : namespaceLabelManager
					.get(namespaceURI)); //see if we have a prefix for this namespace, but only if we shouldn't suppress prefixes
	 ...
	 * @param appendable The appendable used for generating the information.
	 * @param uri The URI of the resource. No prefix will be determined if one is not already available for the namespace URI, if any, of the given resource URI.
	 * @exception NullPointerException if the given appendable and/or URI is <code>null</code>.
	 * @exception IOException if there was an error writing to the appendable.
	 ...
	 * @exception IOException if there was an error writing to the appendable.
	 */
	public static <A extends Appendable> void generateURIReference(final A appendable, URI uri, final TURFNamespaceLabelManager namespaceLabelManager,
			final URI baseURI, final boolean determinePrefix) throws IOException
	{
		...
		//if this URI is not in an inline namespace
		{
	...
	/**
	 * Marks a reference as generated if appropriate. If a reference is to a resource with no properties, or the reference is an inline URI and there is only a
	 * single type of the inline type, there will be no need to generate the resource in full form, so it will be marked as generated. This method is useful for
	 * marking property URI references as generated if they do not need to stand on their own.
	 * @param urf The URF data model.
	...
	/**
	 * Appends a regular expression to an appendable surrounded by the regular expression short form delimiters. The usual reserved string characters, along with
	 * the regular expression delimiter, will be escaped.
	 * @param appendable The appendable to which the information should be appended.
	...
	/**
	 * Returns a regular expression short form surrounded by the regular expression short form delimiters. The usual reserved string characters, along with the
	 * regular expression delimiter, will be escaped.
	...
	/**
	 * Appends a string to an appendable surrounded by the string short form delimiters. The usual reserved string characters, along with the string delimiter,
	 * will be escaped.
	 * @param appendable The appendable to which the information should be appended.
	...
	/**
	 * Returns a string short form surrounded by the string short form delimiters. The usual reserved string characters, along with the string delimiter, will be
	 * escaped.
	...
	/**
	 * Appends a string to an appendable surrounded by specified string delimiters. The usual reserved string characters, along with the string end delimiter,
	 * will be escaped.
	 * @param appendable The appendable to which the information should be appended.
	 * @param string The string to append.
	...
	protected static Appendable appendString(final Appendable appendable, final String string, final char stringBegin, final char stringEnd) throws IOException
	{
		...
		for(int i = 0; i < length; ++i) //for each character index
		{
			...
			switch(c)
			//see which character this is TODO check for surrogates
			{
			...
			//if this character is not escaped and not a control character
			{
				appendable.append(c); //append the character normally
			}
		}
	...
	/**
	 * Writes a list separator. If the generator is formatted, this method generates a newline (optionally preceded by a {@link TURF#LIST_DELIMITER}, depending on
	 * the setting of {@link #isFormattedListDelimiter()}) and and then indents at the current indent level. If the generator is not formatted, a
	 * {@link TURF#LIST_DELIMITER} is generated.
	 * @param appendable The appendable used for generating the information.
	...
	public <A extends Appendable> void writeListSeparator(final A appendable) throws IOException
	{
		...
		//if we shouldn't format the output
		{
			appendable.append(LIST_DELIMITER); //write a list delimiter
		}
	}
	...
	/**
	 * Writes the end of a line and then indents at the current indent level. If the generator is not formatted, no action occurs.
	 * @param appendable The appendable used for generating the information.
	 * @exception NullPointerException if the given appendable is <code>null</code>.
	 * @exception IOException if there was an error writing to the appendable.
	 * @see #isFormatted()
