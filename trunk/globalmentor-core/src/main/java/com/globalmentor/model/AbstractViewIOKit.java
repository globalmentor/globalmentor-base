...
public abstract class AbstractViewIOKit<M> extends DefaultURIAccessible implements ViewIOKit<M> {
	 ...
	 * <p>
	 * This version opens a stream and delegates to <code>load(View, InputStream, URI)</code>.
	 * </p>
	 ...
	 * </p>
	 * <p>
	 * This version opens a stream and delegates to <code>save(View, OutputStream)</code>.
	 * </p>
