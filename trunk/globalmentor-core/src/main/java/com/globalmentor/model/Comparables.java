...
public class Comparables
{
	...
	Identical comparables are always considered equal.
	This method functions exactly as if the two comparables were compared using their {@link Comparable#compareTo(Object)} argument, except:
	<ul>
