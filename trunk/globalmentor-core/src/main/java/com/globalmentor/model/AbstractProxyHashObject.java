...
public abstract class AbstractProxyHashObject {
	...
	/**
	 * Proxied object constructor. Any or all of the proxied objects may be <code>null</code>, but the array of objects may not.
	...
	/**
	 * Indicates whether some other object is "equal to" this one. The other object must be a proxy hash object and one of the objects must be an instance of the
	 * other to be considered equal. Equality is determined by calling the {@link Object#equals(Object)} of the corresponding proxied objects, in order.
