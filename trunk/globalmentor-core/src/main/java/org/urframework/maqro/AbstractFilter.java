...
*/
public abstract class AbstractFilter extends AbstractClassTypedURFResource
{

	/**URI constructor with a type namespace of {@value MAQRO#MAQRO_NAMESPACE_URI}.
	@param uri The URI for the resource, or <code>null</code> if the resource should have no URI.
	*/
	public AbstractFilter(final URI uri)
	{
	...
	*/
	public AbstractFilter(final URI uri, final URI typeNamespaceURI)
	{
