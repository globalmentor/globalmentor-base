...
/**
 * Sorts resources based upon DCMI date. This comparator does not sort unambiguously, and should be used as a delegate comparator of a
...
public class ResourceDCMIDateComparator extends AbstractSortOrderComparator<URFResource>
{
	...
	/**
	 * {@inheritDoc} This implementation compares resources based upon DCMI date. Resources without a date are considered less than those with a date property.
	 * @see DCMI#DATE_PROPERTY_URI
	 */
	@Override
	public int compareImpl(final URFResource resource1, final URFResource resource2)
	{
		return Comparables.compare(getDate(resource1), getDate(resource2)); //compare dates
	}
