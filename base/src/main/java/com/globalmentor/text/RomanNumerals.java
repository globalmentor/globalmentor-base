 ...
 * <p>
 * Integers are used to represent Roman numerals. As a Java integer is 32 bits long, a string would need over two million Roman numeral 'M's to surpass this
 * limit.
 * </p>
 * <p>
 * Conversion algoritms inspired from "When in Rome...." by Jonathan Knudsen at <a href="http://java.oreilly.com/bite-size/java_0698.html">
 * http://java.oreilly.com/bite-size/java_0698.html</a>.
 * </p>
...
public class RomanNumerals {
	 ...
	 * @return The value of the given Roman numeral character, or -1 if the character isn't recognized.
	 */
	 ...
	 * @throws NumberFormatException Thrown if the given string does not contain a valid Roman numeral value.
	 */
