...
/**
 * A class that encapsulates an I/O-related operation on a particular object. For example, a method might retrieve a {@link Writer} from a method, and that
 * method might allow an {@link IOOperation} to be specified that determines how the writer will be initialized if it doesn't already exist.
