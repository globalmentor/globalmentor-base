...
public class Audio {
	 ...
	 */
	public static final ContentType OGG_VORBIS_CONTENT_TYPE = ContentType.of(AUDIO_PRIMARY_TYPE, "ogg");

	/** The content type for MP3: <code>audio/mpeg</code>. */
	public static final ContentType MPEG_CONTENT_TYPE = ContentType.of(AUDIO_PRIMARY_TYPE, "mpeg");
