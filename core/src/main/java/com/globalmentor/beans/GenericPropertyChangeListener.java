...
/**
 * A JavaBeans property change listener retrofitted to use generics to cast to proper value type. An implementing class must override the non-generic property
 ...
 * {@link AbstractGenericPropertyChangeListener}, will be used most often.
