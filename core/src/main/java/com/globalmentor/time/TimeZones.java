...
public class TimeZones {
	 ...
	 * information both as to location and to daylight saving is not provided. This method cannot handle offsets that do not fall on whole minutes.
	...
	/**
	 * Retrieves a time zone based upon a UTC offset days and minutes for the given date. This method cannot return with certain a time zone valid for other
	 * dates, as sufficient information both as to location and to daylight saving is not provided.
	 * @param date The date for which a time zone will be calculated.
