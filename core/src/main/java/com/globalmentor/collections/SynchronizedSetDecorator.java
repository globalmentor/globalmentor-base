...
/**
 * A set that wraps an existing set, providing access through the {@link Set} interface. All collection access is synchronized on the provided synchronization
 * object.
