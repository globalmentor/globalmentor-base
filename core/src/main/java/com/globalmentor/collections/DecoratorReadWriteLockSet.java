...
/**
 * A thread-safe collection decorator that allows many readers but only one writer to access a set at a time. For operations that iterate over live collection
