...
public abstract class AbstractSequenceTask extends AbstractTask implements SequenceTask {
	...
	/**
	 * Goes to the indicated index in the sequence. This is a bound property of type {@link Integer}.
	...
	/**
	 * Determines the current highest valid sequence index. This method is called to validate the allowed range of the sequence index. This version returns
	...
	/**
	 * Starts the sequence annd goes to the first step in the sequence. If the sequence is already started, no action occurs. This implementation delegates to
	 * {@link #start()}, which derived classes should override instead of this method.
	 * @see #start()
	 */
	public void goStart() {
	...
	/**
	 * Starts the sequence by going to the first step in the sequence. This implementation sets the task state to {@link TaskState#INCOMPLETE}. This
	 * implementation calls {@link #goFirst()}.
	...
	/**
	 * Goes to the first step in the sequence. This implementation delegates to {@link #first()}, which derived classes should override instead of this method.
	 * @throws PropertyVetoException if the sequence index change has been vetoed.
	 * @see #first()
	 */
	...
	/**
	 * Goes to the previous step in the sequence. If there is no previous component, no action occurs. This implementation delegates to {@link #previous()}, which
	 * derived classes should override instead of this method.
	 * @throws PropertyVetoException if the sequence index change has been vetoed.
	 * @see #hasPrevious()
	 * @see #previous()
	 */
	...
	/**
	 * Goes to the next step in the sequence. If there is no next step, no action occurs. This implementation delegates to {@link #next()}, which derived classes
	 * should override instead of this method.
	 * @throws PropertyVetoException if the sequence index change has been vetoed.
	 * @see #hasNext()
	 * @see #next()
	 */
	...
	/**
	 * Verifies the contents and finishes the sequence. This implementation delegates to {@link #finish()}, which derived classes should override instead of this
	 * method.
	 * @see #finish()
	 */
	...
	/**
	 * Finishes the sequence. This implementation sets the task state to {@link TaskState#INCOMPLETE}.
	 */
