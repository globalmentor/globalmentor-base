...
*/
	...
	*/
	...
	@param string The string to search.
	@return <code>true</code> if the string has at least one letter.
	*/
	static public boolean hasLetter(final String string) //G***maybe change this to indexOfLetterOrDigit
	{
		for(int i=string.length()-1; i>=0; --i) //look at each character in the string
		{
			if(Character.isLetter(string.charAt(i)))  //if this is a letter
				return true;  //we found a letter
		}
		return false; //we found no letters
	}

	/**Determines if the following string contains a letter or a digit.
	@param string The string to search.
	@return <code>true</code> if the string has at least one letter or digit.
	*/
	static public boolean hasLetterOrDigit(final String string) //G***maybe change this to indexOfLetterOrDigit
	{
		for(int i=string.length()-1; i>=0; --i) //look at each character in the string
		{
			if(Character.isLetterOrDigit(string.charAt(i)))  //if this is a letter or digit
	...
	*/
	...
	/**Determines if the string consists of nothing but the following character.
	@param string The string to examine.
	@param c The character that could make up the entire string.
	@param <code>true</code> if there are no other characters but the specified
	  character, <code>false</code> if there are other characters or if the string
		is the empty string.
	*/
	public final static boolean isAll(final String string, final char c)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each character in the string
		{
			if(string.charAt(i)!=c) //if this isn't the specified character
	...
	/**Determines if the string consists of nothing but characters in the given
		string.
	@param string The string to examine.
	...
	*/
	public final static boolean isAllChars(final String string, final String characters)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each character in the string
		{
			if(characters.indexOf(string.charAt(i))<0) //if this character isn't in the string
	...
	/**Determines whether a string is capitalized.
		A string is capitalized if it contains any characters and the first
		character is uppercase.
	@param string The string to examine.
	@return <code>true</code> if the string is capitalized.
	*/
	public final static boolean isCapitalized(final String string)
	{
		return string.length()>0 && Character.isUpperCase(string.charAt(0)); //determine if the first character is capitalized
	}

	/**Determines whether a string contains only Unicode digits.
	@param string The string to examine.
	@return <code>true</code> if all the characters in the string are digits.
	*/
	public final static boolean isDigits(final String string)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each letter in the string
		{
			if(!Character.isDigit(string.charAt(i))) //if this isn't a digit
	...
	/**Determines whether a string contains only the digits '0'-'9'.
	@param string The string to examine.
	@return <code>true</code> if all the characters in the string are ISO_LATIN_1 digits.
	*/
	public final static boolean isLatinDigits(final String string)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each letter in the string
		{
			if(!isLatinDigit(string.charAt(i))) //if this isn't a Latin digit
	...
	/**Determines whether a string contains only Unicode letters.
	@param string The string to examine.
	@return <code>true</code> if all the characters in the string are letters.
	*/
	public final static boolean isLetters(final String string)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each letter in the string
		{
			if(!Character.isLetter(string.charAt(i))) //if this isn't a letter
	...
	/**Determines whether a string contains only numbers and decimals or commas.
	@param string The string to examine.
	@return <code>true</code> if all the characters represent a number.
	*/
	public final static boolean isNumber(final String string) //G***use a regex, and verify format
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each letter in the string
		{
			final char c=string.charAt(i);  //get this character
	...
	/**Determines whether a string contains only Roman numberals.
	@param string The string to examine.
	@return <code>true</code> if all the characters in the string are roman numerals.
	*/
	public final static boolean isRomanNumerals(final String string)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each character in the string
		{
			if(!isRomanNumeral(string.charAt(i))) //if this isn't a roman numberal
	...
	/**Determines whether all the letters in a string are capital letters.
	@param string The string to examine.
	@return <code>true</code> if all the letters in the string are capitalized.
	*/
	public final static boolean isUpperCase(final String string)
	{
		if(string.length()==0) //if this is an empty string
			return false; //there are no characters to check
		for(int i=string.length()-1; i>=0; --i)  //look at each letter in the string
		{
			final char character=string.charAt(i);  //get this character
