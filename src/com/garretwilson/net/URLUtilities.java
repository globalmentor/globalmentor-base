...
public class URLUtilities implements URLConstants, InputStreamLocator
{
	...
	*/
	...
	@return A <code>File</code> object representing the file of the URL.
	*/
	public static File getFile(final URL url)
	{
		return new File(url.getFile()); //create a new File from the URL file
	}
	...
	*/
	...
	{
		return MediaType.getMediaType(FileUtilities.getExtension(url.getFile())); //return the media type based on the extension of the URL filename
	}
