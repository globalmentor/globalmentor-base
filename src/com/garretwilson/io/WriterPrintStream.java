...
*/
public class WriterPrintStream extends PrintStream	//TODO fix encoding
{
...
//TODO fix	private final String encoding;
  ...
  private Formatter formatter=null;
	...
	*/
	...
	{
		this(writer, autoFlush, Charset.defaultCharset().name());	//construct the print stream with the name of of the system default character encoding
	}

	/**Writer, autoflush, and encoding constructor.
	@param writer The writer to which values and objects will be printed.
	@param autoFlush <code>true</code> writer should be flushed whenever a byte array is written, one of the <code>println</code> methods is invoked, or a newline character or byte (<code>'\n'</code>) is written.
	@param encoding The name of the character encoding in which any bytes written are assumed to be encoded.
	@exception NullPointerException if the given writer and/or encoding is <code>null</code>.
	*/
	private WriterPrintStream(final Writer writer, final boolean autoFlush, final String encoding)	//TODO fix encoding; the specified encoding is currently ignored
	{
...
//TODO fix		this.encoding=checkInstance(encoding, "Encoding cannot be null.");
	}
...
*/
  ...
  */
  ...
  @return <code>true</code> if and only if this stream has encountered an {@link IOException} other than
		{@link InterruptedIOException}, or the {@link #setError()} method has been invoked.
  */
  ...
  /**Write the specified byte to this stream.
	If the byte is a newline and automatic flushing is enabled then the {@link #flush()} method will be invoked.
	This implementation assumes the given byte specifies a single character.
  ...
  */
  ...
  /**Write the specified number of bytes bytes from the specified byte array starting at the specified offset.
	If automatic flushing is enabled then the {@link #flush()} method will be invoked.
	Because a {@link PrintWriter} is expected to be used for writing characters rather than bytes,
	and uses the platform's default character encoding, this version converts the bytes back to characters
  ...
  */
  ...
  /**Writes a string to the underlying writer.
	If automatic flushing is enabled and the string contains the newline character '\\n' then the {@link #flush()} method will be invoked.
	@param string The string to write.
  */
  ...
  /**Writes a newline character to the underlying writer.
	If automatic flushing is enabled then the {@link #flush()} method will be invoked.
	*/
  ...
  */
  ...
  /**Print an integer.
	The string used is the output of {@link java.lang.String#valueOf(int)}.
  ...
  */
  ...
  /**Print a long integer.
	The string used is the output of {@link java.lang.String#valueOf(long)}.
  ...
  */
  ...
  The string used is the output of {@link java.lang.String#valueOf(float)}.
  ...
  */
  ...
  The string used is the output of {@link java.lang.String#valueOf(double)}.
  ...
  */
  ...
  /**Print a string.
  If the argument is <code>null</code> then the string "null" is printed.
  ...
  */
  ...
  /**Print an object.
  The string used is the output of {@link java.lang.String#valueOf(Object)}.
  ...
  */
  ...
  The line separator string is defined by the system property {@value SystemConstants#LINE_SEPARATOR_PROPERTY},
  	and is not necessarily a single newline character (<code>'\n'</code>).
  This implementation delegates to {@link #newLine()}.
  */
  public void println()
  {
  	newLine();
  ...
  This method behaves as though it invokes {@link #print(boolean)} and then {@link #println()}.
  ...
  /**Print a character and then terminates the line.
	This method behaves as though it invokes {@link #print(char)} and then {@link #println()}.
	@param c The character to be printed.
  */
  ...
  /**Print an integer and then terminates the line.
	This method behaves as though it invokes {@link #print(int)} and then {@link #println()}.
	@param i The integer to be printed.
  */
  ...
  This method behaves as though it invokes {@link #print(long)} and then >{@link #println()}.
	@param l The long to be printed.
  */
  ...
  /**Print a float and then terminates the line.
	This method behaves as though it invokes {@link #print(float)} and then {@link #println()}.
	@param f The float to be printed.
  */
  ...
  /**Print a double and then terminates the line.
	This method behaves as though it invokes {@link #print(double)} and then {@link #println()}.
	@param d The double to be printed.
  */
  ...
  /**Print an array of characters and then terminates the line.
	This method behaves as though it invokes {@link #print(char[])} and then <code>{@link #println()}</code>.
  ...
  */
  ...
  /**Print a string and then terminates the line.
	This method behaves as though it invokes {@link #print(String)} and then {@link #println()}.
  ...
  */
  ...
  /**Print an object and then terminates the line.
	This method behaves as though it invokes {@link #print(Object)} and then {@link #println()}.
	@param object The object to be printed.
  */
  public void println(final Object object)
  {
	...
	<p>The locale always used is the one returned by {@link java.util.Locale#getDefault() Locale.getDefault()}, regardless of any previous invocations of other formatting methods on this object.</p>
	...
	*/
	...
	{
			//TODO check open and handle I/O exceptions
		synchronized(this)
		{
