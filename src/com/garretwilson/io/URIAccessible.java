...
public interface URIAccessible extends URIInputStreamable, URIOutputStreamable
{
	...
	public final String BASE_URI_PROPERTY=URIAccessible.class.getName()+Java.PACKAGE_SEPARATOR+"baseURI";

	/**The URI input streamable property, if it is bound to an object..*/
	public final String URI_INPUT_STREAMABLE_PROPERTY=URIAccessible.class.getName()+Java.PACKAGE_SEPARATOR+"uriInputStreamable";

	/**The URI output streamable property, if it is bound to an object..*/
	public final String URI_OUTPUT_STREAMABLE_PROPERTY=URIAccessible.class.getName()+Java.PACKAGE_SEPARATOR+"uriOutputStreamable";
