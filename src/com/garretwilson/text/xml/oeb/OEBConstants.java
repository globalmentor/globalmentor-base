...
public interface OEBConstants extends XHTMLConstants
{
	...
	public static final String OEB1_PACKAGE_NAMESPACE_URI="http://openebook.org/namespaces/oeb-package/1.0/";
	...
	public final static MediaType OEB10_PACKAGE_MEDIA_TYPE=new MediaType(MediaType.TEXT, MediaType.X_OEB1_PACKAGE);

		/**The media type of an OEB 1.0 document.*/
	public final static MediaType OEB10_DOCUMENT_MEDIA_TYPE=new MediaType(MediaType.TEXT, MediaType.X_OEB1_DOCUMENT);

		/**The media type of an OEB 1.0 CSS document.*/
	public final static MediaType OEB10_CSS_MEDIA_TYPE=new MediaType(MediaType.TEXT, MediaType.X_OEB1_CSS);
	...
	public static final String OEB1_DOCUMENT_NAMESPACE_URI="http://openebook.org/namespaces/oeb-document/1.0/";
