...
public interface ABNFConstants
{
	...
	public final static String ALPHA_CHARS=StringUtilities.create((char)0x41, (char)0x5A)+StringUtilities.create((char)0x61, (char)0x7A);
	...
	public final static String CHAR_CHARS=StringUtilities.create((char)0x01, (char)0x7F);	
	...
	public final static String CTL_CHARS=StringUtilities.create((char)0x00, (char)0x1F)+(char)0x7F;	

	/**Digit characters: 0x30-39 (0-9).*/
	public final static String DIGIT_CHARS=StringUtilities.create((char)0x30, (char)0x39);	
	...
	public final static String OCTET_CHARS=StringUtilities.create((char)0x00, (char)0xff);

	/**Visible (printing) characters: 0x21-7E.*/ 
	public final static String VCHAR_CHARS=StringUtilities.create((char)0x21, (char)0x7E);
