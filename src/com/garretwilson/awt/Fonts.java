...
//TODO fix for Arabic				if(unicodeBlock.equals(Character.UnicodeBlock.ARABIC) ||  //if this is an unrecognized Arabic character TODO what about the other Arabic sections?
...
//TODO fix for Arabic				if(unicodeBlock.equals(Character.UnicodeBlock.ARABIC))  //if this is an unrecognized Arabic character
//TODO fix for Arabic					return getFont(childView, "Lucinda Sans Regular", font.getStyle(), font.getSize()); //use the font we know can display this character correctly TODO fix, use constants TODO what about the font.getSize2D()?
...
//TODO del					return possibleFont;  //return the font
				}
			}
		}
...
//TODO del				  chosenFont=availableFont;  //show that we've chosen a font
					break;  //stop searching
//TODO del					return availableFont;  //return the font
				}
			}
		}
		if(chosenFont!=null)  //if we found a font
		{
//TODO del Log.trace("Storing character keyed to character: "+character);
