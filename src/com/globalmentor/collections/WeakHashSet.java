...
/**A class that implements the <code>Set</code> interface, backed by a
	{@link WeakHashMap}. This means that members of the set will
	be collected by the garbage collector when they are no longer in ordinary
	use.
<p>This class was created referencing {@link java.util.HashSet}
...
public class WeakHashSet<E> extends AbstractSet<E> implements Set<E>
{
	...
	/**Constructs a new, empty set. The backing {@link WeakHashMap} instance
	...
	/**Constructs a new set containing the elements in the specified
		collection.  The {@link WeakHashMap} is created with default load
	...
	*/
	 ...
	 *         prevents it from being added to this set.
	 */
	public boolean add(E o) {return map.put(o, DUMMY_VALUE)==null;}
