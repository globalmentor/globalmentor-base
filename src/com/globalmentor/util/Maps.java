...
public class Maps
{
	...
	If more than one pair with the same name is given, the last one will override the others.
	...
	*/
	...
	/**Associates the specified value with the specified key in this map.
		...
		replaced by the specified value. If <var>value</var> is <code>null</code>,
		the value with the specified key will be removed from the map.
	@param map The map into which the value should be put.
	@param key The key with which the specified value is to be associated.
	@param value The value to be associated with the specified key, or
		<code>null</code> if the value associated with the key should be removed.
	@return The previous value associated with specified key, or
		<code>null</code> if there was no mapping for key.
	@throws UnsupportedOperationException Thrown if the <code>put</code> operation
		is not supported by this map.
	@throws ClassCastException Thrown if the class of the specified key or value
		prevents it from being stored in this map.
	@throws IllegalArgumentException if some aspect of this key or value
		prevents it from being stored in this map.
	@throws NullPointerException this map does not permit <code>null</code>
		keys, and the specified key is <code>null</code>.
	*/
	...
	/**Retains only the entries in the map the keys of which have a corresponding entry in the given set. 
