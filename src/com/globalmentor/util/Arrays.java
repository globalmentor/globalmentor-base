...
public class Arrays
{
	...
	@return A new array containing the contents of the first array followed by
	...
	*/
	...
	/**Creates a new array and appends the contents of <var>array2</var> to the
		contents of <var>array1</var>.
	...
	*/
	...
	/**Convenience method that returns the given object if and only if it is an
		instance of an array of the given class. This method is equivalent to
	...
	*/
	public static void checkRange(final int length, int fromIndex, int toIndex)
	{
	...
	/**Creates a new integer array with the specified size with content from the
		original array. Effectively changes the size of the original array by making
		a copy. The number of elements copied is equal to the minimum of the size
		of the original array and the size of the new array.
	@param length The size at which the new array should be created.
	@param a The array whose content will be copied, or <code>null</code> if
		there are no values to copy..
	@return A new array with the content of the old array at the corresponding
		indeces.
	*/
	...
	*/
	...
	The returned array is identical to the implicit array passed into this method.
	...
	*/
	...
	The range to be filled extends from index <code>fromIndex</code>, inclusive, to index <code>toIndex</code>, exclusive.
	@param array The array to be filled..
	...
	*/
	...
	{
		checkRange(array.length, fromIndex, toIndex);	//check the given range
		for(int i=fromIndex; i<toIndex; array[i++]=value);	//store the value in each index of the array
		return array;	//return the array
	}
	...
	*/
	...
	@return A string array, each element of which contains the string version of the corresponding object array element or <code>null</code> if the corresponding object is <code>null</code>.
