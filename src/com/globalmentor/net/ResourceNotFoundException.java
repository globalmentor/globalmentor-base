...
public class ResourceNotFoundException extends ResourceIOException
{
	...
	*/
	public ResourceNotFoundException(final URI resourceURI)
	{
	...
	@exception NullPointerException if the given resource URI is <code>null</code>.
	*/
	public ResourceNotFoundException(final URI resourceURI, final String message)
	{
	...
	@exception NullPointerException if the given resource URI is <code>null</code>.
	*/
	public ResourceNotFoundException(final URI resourceURI, final Throwable cause)
	{
	...
	@exception NullPointerException if the given resource URI is <code>null</code>.
	*/
	public ResourceNotFoundException(final URI resourceURI, final String message, final Throwable cause)
	{
