...
<p>Vetoable change support is only created when needed; if no vetoable change
	listeners are added, the vetoable change support will never be created or
	invoked, even when firing vetoable change events.</p>
<p>This class was modeled in part from the property support of {@link java.awt.Component}.</p>
...
public class BoundPropertyObject implements PropertyBindable, PropertyConstrainable
{
  ...
  */
	...
	*/
	...
	If any veotable change listeners vetos the change, then a new event will be fired reverting all the listeners to the old value, after which the {@link PropertyVetoException} will be rethrown.
	No event is fired if old and new are equal and non-<code>null</code>.
	This method delegates actual firing of the event to {@link #fireVetoableChange(PropertyChangeEvent)}.
  ...
  public <V> void fireVetoableChange(final String propertyName, V oldValue, V newValue) throws PropertyVetoException
	...
	/**Reports that an integer vetoable property updtae to any registered listeners, reporting old and new values of type <code>Integer</code>.
	No event is fired if the values are equal, or if no event is fired if no listeners are registered for the given property.
	This method delegates actual firing of the event to {@link #fireVetoableChange(String, V, V)}.
	@param propertyName The name of the property that is about to change.
	@param oldValue The old property value.
	@param newValue The new property value.
	@exception PropertyVetoException if the recipient wishes the property change to be rolled back.
	*/
	...
	/**Reports that an integer vetoable property updtae to any registered listeners, reporting old and new values of type <code>Boolean</code>.
	No event is fired if the values are equal, or if no event is fired if no listeners are registered for the given property.
	This method delegates actual firing of the event to {@link #fireVetoableChange(String, V, V)}.
	@param propertyName The name of the property that is about to change.
	@param oldValue The old property value.
