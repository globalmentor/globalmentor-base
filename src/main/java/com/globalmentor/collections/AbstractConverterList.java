...
public abstract class AbstractConverterList<S, D> extends ListDecorator<D> { //TODO add conversion access for all necessary methods
	 ...
	 * @param list The list the elements of which this list should convert.
	 * @param reuse <code>true</code> if the converter should remember and reuse converted objects, or <code>false</code> if the conversion should take place from
	 *          scratch upon each request.
	 */
	...
	/**
	 * Converts an object in the list to another object or retrieves it from the converted object map if it has already been converted and saved.
	 * @param source The object to convert.
	 ...
	 * @param index The index of first element to be returned from the list iterator (by a call to the <code>next</code> method).
